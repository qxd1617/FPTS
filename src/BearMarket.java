 ...
 */
public class BearMarket implements SimulationInterface{
    ...
    public BearMarket(HashMap<Equity,Float> Portfolio, String timeInterval, Float percentage)
    {
    ...
    public HashMap<Equity,Float> Simulate()
    {
        ...
        for(Equity object: currentPortfolio.keySet()) //Update all stocks with the price drop
        {
